// Phone country codes with correct ISO codes for flags
// Contains accurate dial codes for all countries with their ISO codes
...
const phoneCodes = [
  ...
  { code: "+1268", name: "Antigua and Barbuda", isoCode: "ag" },
  ...
  { code: "+238", name: "Cabo Verde", isoCode: "cv" },
  ...
  { code: "+1767", name: "Dominica", isoCode: "dm" },
  { code: "+1809", name: "Dominican Republic", isoCode: "do" },
  ...
  { code: "+1868", name: "Trinidad and Tobago", isoCode: "tt" },
...
// Make sure India is at the top of the list for easy selection
const indiaIndex = phoneCodes.findIndex(country => country.code === "+91");
if (indiaIndex !== -1) {
  const india = phoneCodes.splice(indiaIndex, 1)[0];
  phoneCodes.unshift(india);
}

// Common areas with different country codes
const specialCodes = [
  { code: "+1242", name: "Bahamas", isoCode: "bs" },
  { code: "+1246", name: "Barbados", isoCode: "bb" },
  { code: "+1264", name: "Anguilla", isoCode: "ai" },
  { code: "+1268", name: "Antigua and Barbuda", isoCode: "ag" },
  { code: "+1284", name: "British Virgin Islands", isoCode: "vg" },
  { code: "+1340", name: "U.S. Virgin Islands", isoCode: "vi" },
  { code: "+1345", name: "Cayman Islands", isoCode: "ky" },
  { code: "+1441", name: "Bermuda", isoCode: "bm" },
  { code: "+1473", name: "Grenada", isoCode: "gd" },
  { code: "+1649", name: "Turks and Caicos Islands", isoCode: "tc" },
  { code: "+1664", name: "Montserrat", isoCode: "ms" },
  { code: "+1671", name: "Guam", isoCode: "gu" },
  { code: "+1684", name: "American Samoa", isoCode: "as" },
  { code: "+1721", name: "Sint Maarten", isoCode: "sx" },
  { code: "+1758", name: "Saint Lucia", isoCode: "lc" },
  { code: "+1767", name: "Dominica", isoCode: "dm" },
  { code: "+1784", name: "Saint Vincent and the Grenadines", isoCode: "vc" },
  { code: "+1809", name: "Dominican Republic", isoCode: "do" },
  { code: "+1829", name: "Dominican Republic", isoCode: "do" },
  { code: "+1849", name: "Dominican Republic", isoCode: "do" },
  { code: "+1868", name: "Trinidad and Tobago", isoCode: "tt" },
  { code: "+1869", name: "Saint Kitts and Nevis", isoCode: "kn" },
  { code: "+1876", name: "Jamaica", isoCode: "jm" }
];

// Add special codes to the main list
phoneCodes.push(...specialCodes);
