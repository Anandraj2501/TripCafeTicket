    ...
    <>
     ...
     <div className="md:container md:mx-auto py-12 px-3 sd:px-10  md:px-10 lg:px-10 xl:px-10 2xl:px-10  ">
        <div className='bg-[#fff] p-3  rounded-md' >
            ...
            <h3 className='text-[1.5rem] font-bold'>PURPOSE OF THE WEBSITE, ITS CONTENT, SERVICES</h3>
           ...
           <li>Technical glitches or errors.</li>
           <li>Issues that are beyond the business's control.</li>
           <li>Failures in the booking process.</li>
           <li>Problems with the payment gateway.</li>
           <li>Any other issues beyond our control.</li>
...
<p className='text-[1rem] pb-2'>We as a merchant shall be under no liability whatsoever in respect of any loss or damage arising directly or indirectly out of the decline of authorization for any Transaction, on Account of the Cardholder having exceeded the preset limit mutually agreed by us with our acquiring bank from time to time.</p>
<h3 className='text-[1.5rem] font-bold'>YOUR RESPONSIBILITIES </h3>
...
<h3 className='text-[1.5rem] font-bold'>PAYMENT POLICIES </h3>
<p className='text-[1rem] pb-2'><strong>The accepted methods of payment, charges and other terms are as follows:</strong></p>
<ol className='list-decimal ml-5 py-3 text-[1rem]'>
<li><strong>Payment Methods</strong><br/>
Credit and Debit Cards: The business accepts various types of cards, including Credit Cards and Debit Cards, specifically those issued by MasterCard and Visa. The availability of these options depends on what the payment gateway supports.</li>
<li><strong>PayPal for International Users</strong><br/>
International Payments: International users can use PayPal to pay for services. However, the business only accepts PayPal payments from users outside of India.</li>
<li><strong>Bank Transfers as an Alternative</strong><br/>
Direct Bank Transfers: If you are unable to use cards or PayPal, the business offers the option to pay via bank transfers. This can be done through RTGS (Real Time Gross Settlement), NEFT (National Electronic Funds Transfer), or IMPS (Immediate Payment Service), allowing you to send money directly from your bank account to the business.</li>
<li><strong>Additional Charges</strong><br/>
The user is responsible for paying any additional charges that may apply when making payments. These could include:</li>
    <ol className='list-decimal ml-5 py-3 pt-1 text-[1rem]'>
    <li><strong>Conversion Charges:</strong> Fees related to currency conversion.</li>
    <li><strong>Forex Markup:</strong> Charges for foreign exchange services.</li>
    <li><strong>Bank Transfer Charges:</strong> Fees for sending money via bank transfer.</li>
    <li><strong>GST and Other Applicable Taxes:</strong> Any taxes that may apply to the transaction.</li>
    <li><strong>Airline Charges:</strong> Any fees imposed by airlines during the booking process.</li>
    <li><strong>Bank Transaction Charges:</strong> Fees associated with processing payments through the bank.</li>
    </ol>
