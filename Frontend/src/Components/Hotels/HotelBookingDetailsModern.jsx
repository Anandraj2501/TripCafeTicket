...
const HotelBookingDetailsModern = () => {
    ...
    const handlePaymentClick = () => {
        const amount = hotelTravellersDetails?.passengers?.length * 500;
        const finalData = { ...hotelTravellersDetails, amount, ...hotelData, selectedPaymentMethod, hotelInfo }
    ...
    const fetchHotelDetails = async () => {
        try {
            const response = await axios.get(`${process.env.NODE_ENV === 'development' ? process.env.REACT_APP_DEV_BACKEND_URL : process.env.REACT_APP_PRODUCTION_BACKEND_URL}/booking/searchHotel`, {
                params: hotelData
            });
            console.log("Hotel Info Response:", response);
            setHotelInfo(response?.data?.properties[0]);
                                ...
                                <div className="p-5 space-y-5">
                                    ...
                                    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                                        <div className="flex items-center mb-3">
                                            ...
                                            <div className="font-medium text-lg text-[#162856]">Hotel Booking - {hotelData?.city || "City Name"}</div>
                                        </div>

                                        {hotelInfo && Array.isArray(hotelInfo?.images) && hotelInfo?.images?.length > 0 &&
                                            <div className="flex flex-col mb-3">
                                                <div className="h-40 w-full rounded-xl overflow-hidden shadow-md border border-gray-200 flex items-center justify-center mr-4 mb-3 flex-col">
                                                    <img src={hotelInfo.images[0]?.thumbnail}
                                                        alt="Hotel Thumbnail"
                                                ...
                                                <div className="flex justify-between items-center w-full">
                                                    <span className="flex">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-6 w-6 text-[rgb(29,181,236)]">
                                                    ...
                                                    <div className="flex items-center bg-orange-100 rounded-lg px-3 py-1">
                                                        <Star size={16} className="text-orange-500 mr-1 fill-orange-500" />
                                                        <span className="font-medium text-orange-800">{hotelInfo?.overall_rating?.toFixed(1)}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        }
                                    ...
                                    <div className="border border-gray-100 rounded-lg overflow-hidden">
                                        ...
                                        <div className="p-4 space-y-3">
                                            <div className="flex justify-between text-sm">
                                                ...
                                                <span className="font-medium">₹{500 * hotelTravellersDetails.passengers.length}</span>
                                            </div>

                                            <div className="border-t border-dashed border-gray-200 pt-3 flex justify-between">
                                                <span className="font-medium">Total Amount</span>
                                                <span className="font-bold text-[rgb(29,181,236)]">₹{500 * hotelTravellersDetails.passengers.length}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="rounded-lg border border-gray-100 flex flex-col">
                                        ...
                                        <div className="flex flex-col gap-y-2 text-lg font-medium text-[#162856] mt-4">
                                            ...
                                            <div className="w-full  text-center bg-[rgb(29,181,236)] hover:bg-[#d15518] text-white font-bold text-lg py-2 px-3 rounded-lg mt-4  transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[rgb(29,181,236)] focus:ring-opacity-50 cursor-pointer" onClick={handlePaymentClick}>
                                                Pay Now
                                            </div>
                                        </div>
                                    </div>
...
export default HotelBookingDetailsModern; 