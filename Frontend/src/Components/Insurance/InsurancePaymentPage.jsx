...
const InsurancePaymentPage = () => {
    ...
    const initiateRazorpayPayment = async () => {
        setLoading(true);
        try {
            const response = await axios.post(`${process.env.NODE_ENV === 'development' ? process.env.REACT_APP_DEV_BACKEND_URL : process.env.REACT_APP_PRODUCTION_BACKEND_URL}/initiatePayment/insurancerazorpay`, JSON.stringify(bookingData), {
                headers: {
            ...
            if (response.status === 200) {
                try{
                    ...
                    var options = {
                        ...
                        "currency": currency,
                        "description": "Insurance Booking",
                        "order_id": id, //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
                        "callback_url": `${process.env.NODE_ENV === 'development' ? process.env.REACT_APP_DEV_BACKEND_URL : process.env.REACT_APP_PRODUCTION_BACKEND_URL}/initiatePayment/verifyInsurancePayment/${bookingData?.txnid}`, //This is the URL where Razorpay will send the payment status
                ...
                <div className="w-full max-w-5xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[rgb(29,181,236)]/20">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="mb-8">
                                <h3 className="text-xl font-semibold text-[#162856] mb-4 flex items-center">
                                    <FaUserCircle className="mr-2 text-[rgb(29,181,236)]" /> Travellers
                                </h3>
                                <div className="bg-gray-50 rounded-lg border border-gray-100">
                                    <div className="bg-gray-100 py-3 px-4 rounded-t-lg border-b border-gray-200">
                                        <div className="grid grid-cols-12 font-medium text-[#162856]">
                                            ...
                                            <div className="col-span-11">Traveller Name</div>
                                        </div>
                                    </div>
