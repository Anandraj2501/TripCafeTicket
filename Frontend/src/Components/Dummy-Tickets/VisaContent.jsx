                ...
                <div className="container mx-auto px-3 md:px-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
                            <div className="w-20 h-20 mb-6 flex items-center justify-center text-[rgb(29,181,236)]">
                    ...
                    <div className="flex flex-wrap gap-x-10">
                        ...
                        <div className="right w-full md:w-[56.5%] flex flex-col items-center justify-center gap-y-6">
                            ...
                            <p className="text-sm md:text-base text-justify">
                                At TripCafeTicket.com, we are a team of seasoned travel professionals with over a decade of experience in the travel and tourism industry. Our in-depth knowledge of visa application requirements across Asia, Europe, Africa, the Americas, Australia, and New Zealand ensures you get accurate, embassy-accepted booking documents — minimizing any potential loss in case of a visa refusal.
                            ...
                            <ul className="pl-0 w-full space-y-3">
                                <li className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm md:text-base leading-relaxed">
                                        ✅ Valid Dummy Flight & Hotel Bookings — Created to meet official visa application criteria.
                                    </div>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm md:text-base leading-relaxed">
                                        ⚡ Instant PDF Download — Get your reservation documents within minutes.
                                    </div>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm md:text-base leading-relaxed">
                                        ✈ Same Price for All Routes — Whether it’s one-way, roundtrip, or multi-city, pricing is simple and transparent (calculated as double the stated rate per passenger).
                                    </div>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm md:text-base leading-relaxed">
                                        🌍 Smart Travel Options — Avoid flight routes with transits through countries requiring additional transit visas (like the US or UK).
                                    </div>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm md:text-base leading-relaxed">
                                        🔁 Unlimited Date Revisions — Change your travel dates anytime, free of charge.
                                    </div>
                                </li>
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm md:text-base leading-relaxed">
                                        ...
                                        ❌ No Cancellation Fees — Hassle-free flexibility whenever you need it.
                                    </div>
                                </li>
                            </ul>
