    ...
    return (
        <>
                   ...
                   <div className="flex flex-wrap gap-x-10">
                       <div className="left w-full md:w-[56.5%] flex flex-col items-center justify-center gap-y-6">
                           ...
                           <p className="text-[#333] text-base md:text-xl font-medium text-justify">
                               ...
                               TripCafe helps you obtain dummy reservations for flight & hotel to any destinations or countries instantly. These reservations are acceptable for visa application to any country.
                           </p>
                       </div>
           ...
           <section className="w-full px-3 bg-gradient-to-b from-gray-50 to-white py-20">
               <div className="container mx-auto px-3 md:px-10">
                   <h1 className="text-3xl md:text-5xl font-bold text-center mb-16">Benefits: Why Choose TripCafe
</h1>
               ...
               <div className="container mx-auto px-3 md:px-10">
                   <div className="flex flex-wrap gap-x-10">
                       ...
                       <div className="right w-full md:w-[56.5%] flex flex-col items-center justify-center gap-y-6">
                           <h2 className="text-2xl md:text-4xl font-bold text-center md:text-left">Why TripCafeHolidays?</h2>
